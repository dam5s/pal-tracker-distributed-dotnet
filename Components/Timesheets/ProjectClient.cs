...
namespace Timesheets
{
    public class ProjectClient : IProjectClient
    {
        ...
        private async Task<ProjectInfo> DoGet(long projectId)
        {
            ...
            _logger.LogInformation("Attempting to fetch projectId: {ProjectId}", projectId);
            ...
            _logger.LogInformation("Caching project Id: {ProjectId}", projectId);
        ...
        {
            _logger.LogInformation("Retrieving from cache projectId: {ProjectId}", projectId);
